#' benchmark.getDTeval
#'
#' @description Performs a benchmarking experiment for data.table coding statements that
#' use get() or eval() for programmatic designs.  The a) original statement is compared to b)
#' passing the original statement through getDTeval and also to c) an optimized coding statement.
#' The results can demonstrate the overall improvement of using the coding translations offered by getDTeval().
#'
