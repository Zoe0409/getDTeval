...
```{r example1}
dat1 <- dat[sample(x = 1:.N, size = 10^6, replace = TRUE)]

the.statement <- "dat1[get(age.name) > 65, .(mean_awareness = mean(get(awareness.name))), keyby = c(eval(gender.name), region.name)]"
